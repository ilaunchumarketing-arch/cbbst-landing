...
const products: Product[] = [
  ...
  {
    name: "ULTIMATE FALLOUT #4 CGC 9.8 — 1st Miles Morales",
    price: "$1,150.00",
    badge: "🏆 CGC 9.8",
    badgeColor: "bg-cbbst-gold text-black",
  ...
  {
    name: "SOMETHING IS KILLING THE CHILDREN – CBBST EXCLUSIVE",
    price: "$45.00",
    badge: "EXCLUSIVE",
    badgeColor: "bg-cbbst-red",
  ...
  {
    name: "TMNT – CBBST EXCLUSIVE VARIANT",
    price: "$35.00",
    badge: "✨ NEW",
    badgeColor: "bg-cbbst-gold text-black",
    href: "/products/tmnt-exclusive-variant",
    image: "/images/comic_art_6.jpg",
  },
  {
    name: 'SUPERIOR STAND "STAND ALONE EDITION" – 10 Colors',
    price: "$20.00",
    badge: "💰 SALE",
    badgeColor: "bg-green-600",
    href: "/products/superior-stand-alone-edition",
